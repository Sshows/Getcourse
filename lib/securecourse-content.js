export const securecourseContent = {
  ...
  publicSite: {
    ...
    hero: {
      eyebrow: "Site + Admin + Student Cabinet",
      title: "A protected course platform where the student learns in the browser",
      lead:
        "This platform separates public marketing, operational administration, and protected consumption into three dedicated interfaces. The public website handles discovery and activation, the admin panel controls access and content, and the student cabinet provides the primary place where the student watches lessons securely in the browser.",
      actions: [
        { href: "/securecourse/admin", label: "Open admin demo", kind: "solid" },
        { href: "/securecourse/student", label: "Open student cabinet", kind: "outline" }
      ],
      notes: [
    ...
    logicMatrix: [
      ...
      },
      {
        ...
        copy:
          "Handles lesson viewing, progress tracking, watermark rendering, inactivity logout, and privacy reactions — all inside the browser."
      },
      {
        title: "Backend + Redis",
        copy:
  ...
  studentApp: {
    ...
    lessonsLocation:
      "Students watch protected lessons in the student web cabinet in the browser. The public site only activates or redirects access.",
    protectionChecklist: [
